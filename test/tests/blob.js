...
describe("Blob", function () {
  ...
  after(function () {
    return exec("git clean -xdf", { cwd: reposPath })
      ...
      .then(function () {
        return exec("git reset --hard " + previousCommitOid, {
          cwd: reposPath,
        });
      });
  });
  ...
  describe("createFromBuffer", function () {
    ...
    it("throws an error when buffer is null", function () {
      var test = this;
      return Blob.createFromBuffer(test.repository, null).catch(function (
        error
      ) {
  ...
  describe("createFromDisk", function () {
    ...
    it("throws an error when the file cannot be found", function () {
      ...
      return Blob.createFromDisk(test.repository, "aaaaaaaaaa").catch(function (
        error
      ) {
  ...
  describe("createFromWorkdir", function () {
    ...
    it("throws an error when path is null", function () {
      var test = this;
      return Blob.createFromWorkdir(test.repository, null).catch(function (
        error
      ) {
